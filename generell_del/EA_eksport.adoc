=== Pakke «ApplicationSchema» FKB Generell del-5.0Utkast
...
image::diagrammer/Realisering fra SOSI generelle typer.png[link=diagrammer/Realisering fra SOSI generelle typer.png, window=_blank, alt="Diagramm: Realisering fra SOSI generelle typer"]
...
image::diagrammer/Hoveddiagram Mekanismer til bruk i distribusjon.png[link=diagrammer/Hoveddiagram Mekanismer til bruk i distribusjon.png, window=_blank, alt="Diagramm: Hoveddiagram Mekanismer til bruk i distribusjon"]
 
.Realisering av elementer fra SOSI Generell del 
image::diagrammer/Realisering av elementer fra SOSI Generell del.png[link=diagrammer/Realisering av elementer fra SOSI Generell del.png, window=_blank, alt="Diagramm: Realisering av elementer fra SOSI Generell del"]
