...
image::diagrammer/Realisering fra Plan 4.5.png[link=diagrammer/Realisering fra Plan 4.5.png, window=_blank, alt="Diagramm: Realisering fra Plan 4.5"]
 
.Hoveddiagram - objekttyper og kodelister 
image::diagrammer/Hoveddiagram - objekttyper og kodelister.png[link=diagrammer/Hoveddiagram - objekttyper og kodelister.png, window=_blank, alt="Diagramm: Hoveddiagram - objekttyper og kodelister"]
