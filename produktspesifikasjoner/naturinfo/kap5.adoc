...
[caption="Figur 5: ",title=Realisering av fellesegenskaper fra FKB generell del]
image::figurer/Realisering av fellesegenskaper fra FKB generell del.png[Realisering av fellesegenskaper fra FKB generell del]
