...
[caption="Figur 4: ",title=Realisering av objekttyper og datatyper]
image::diagrammer/Realisering av objekttyper og datatyper.png[Realisering av objekttyper og datatyper]
...
[caption="Figur 5: ",title=Illustrasjon av objekttype Veglenke]
image::https://skjema.geonorge.no/SOSI/produktspesifikasjon/FKB-TraktorvegSti/5.0/figurer/objtype_veglenke.png[https://skjema.geonorge.no/SOSI/produktspesifikasjon/FKB-TraktorvegSti/5.0/figurer/objtype_veglenke.png]
===== Egenskaper
[cols="20,80"]
|===
|*Navn:* 
...
|===
[caption="Figur 6: ",title=Illustrasjon av objekttype Vegsperring]
image::https://skjema.geonorge.no/SOSI/produktspesifikasjon/FKB-TraktorvegSti/5.0/figurer/objtype_vegsperring.png[https://skjema.geonorge.no/SOSI/produktspesifikasjon/FKB-TraktorvegSti/5.0/figurer/objtype_vegsperring.png]
===== Egenskaper
[cols="20,80"]
|===
|*Navn:* 
