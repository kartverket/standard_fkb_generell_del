...
image::diagrammer/Oversiktsdiagram FKB-Veg 5.0.png[link=diagrammer/Oversiktsdiagram FKB-Veg 5.0.png, window=_blank, alt="Diagramm: Oversiktsdiagram FKB-Veg 5.0"]
...
image::http://skjema.geonorge.no/SOSI/produktspesifikasjon/FKB-Veg/5.0/figurer/objtype_parkeringsomr%c3%a5de.png[alt="Illustrasjon av objekttype: Parkeringsområde"]
===== Egenskaper
[cols="20,80"]
|===
|*Navn:* 
...
image::http://skjema.geonorge.no/SOSI/produktspesifikasjon/FKB-Veg/5.0/figurer/objtype_trafikkoy.png[alt="Illustrasjon av objekttype: Trafikkøy"]
===== Egenskaper
[cols="20,80"]
|===
|*Navn:* 
...
image::http://skjema.geonorge.no/SOSI/produktspesifikasjon/FKB-Veg/5.0/figurer/objtype_veggaendeogsyklende.png[alt="Illustrasjon av objekttype: VegGåendeOgSyklende"]
===== Egenskaper
[cols="20,80"]
|===
|*Navn:* 
...
image::http://skjema.geonorge.no/SOSI/produktspesifikasjon/FKB-Veg/5.0/figurer/objtype_vegkjorende.png[alt="Illustrasjon av objekttype: VegKjørende"]
===== Egenskaper
[cols="20,80"]
|===
|*Navn:* 
...
image::diagrammer/Parkeringsområde flateavgrensning.png[link=diagrammer/Parkeringsområde flateavgrensning.png, window=_blank, alt="Diagramm: Parkeringsområde flateavgrensning"]
 
.Trafikkøy flateavgrensning 
image::diagrammer/Trafikkøy flateavgrensning.png[link=diagrammer/Trafikkøy flateavgrensning.png, window=_blank, alt="Diagramm: Trafikkøy flateavgrensning"]
 
.VegGåendeOgSyklende flateavgrensning 
image::diagrammer/VegGåendeOgSyklende flateavgrensning.png[link=diagrammer/VegGåendeOgSyklende flateavgrensning.png, window=_blank, alt="Diagramm: VegGåendeOgSyklende flateavgrensning"]
 
.VegKjørende flateavgrensning 
image::diagrammer/VegKjørende flateavgrensning.png[link=diagrammer/VegKjørende flateavgrensning.png, window=_blank, alt="Diagramm: VegKjørende flateavgrensning"]
...
image::http://skjema.geonorge.no/SOSI/produktspesifikasjon/FKB-Veg/5.0/figurer/objtype_vegannenavgrensning.png[alt="Illustrasjon av objekttype: VegAnnenAvgrensning"]
===== Egenskaper
[cols="20,80"]
|===
|*Navn:* 
...
image::http://skjema.geonorge.no/SOSI/produktspesifikasjon/FKB-Veg/5.0/figurer/objtype_vegdekkekant.png[alt="Illustrasjon av objekttype: Vegdekkekant"]
===== Egenskaper
[cols="20,80"]
|===
|*Navn:* 
...
image::http://skjema.geonorge.no/SOSI/produktspesifikasjon/FKB-Veg/5.0/figurer/objtype_vegfiktivgrense.png[alt="Illustrasjon av objekttype: VegFiktivGrense"]
===== Egenskaper
[cols="20,80"]
|===
|*Navn:* 
...
image::http://skjema.geonorge.no/SOSI/produktspesifikasjon/FKB-Veg/5.0/figurer/objtype_annetvegarealavgrensning.png[alt="Illustrasjon av objekttype: AnnetVegarealAvgrensning"]
===== Egenskaper
[cols="20,80"]
|===
|*Navn:* 
...
image::http://skjema.geonorge.no/SOSI/produktspesifikasjon/FKB-Veg/5.0/figurer/objtype_fartsdemperavgrensning.png[alt="Illustrasjon av objekttype: FartsdemperAvgrensning"]
===== Egenskaper
[cols="20,80"]
|===
|*Navn:* 
...
image::http://skjema.geonorge.no/SOSI/produktspesifikasjon/FKB-Veg/5.0/figurer/objtype_feristavgrensning.png[alt="Illustrasjon av objekttype: FeristAvgrensning"]
===== Egenskaper
[cols="20,80"]
|===
|*Navn:* 
...
image::http://skjema.geonorge.no/SOSI/produktspesifikasjon/FKB-Veg/5.0/figurer/objtype_gangfeltavgrensning.png[alt="Illustrasjon av objekttype: GangfeltAvgrensning"]
===== Egenskaper
[cols="20,80"]
|===
|*Navn:* 
...
image::http://skjema.geonorge.no/SOSI/produktspesifikasjon/FKB-Veg/5.0/figurer/objtype_kjorbanekant.png[alt="Illustrasjon av objekttype: Kjørebanekant"]
===== Egenskaper
[cols="20,80"]
|===
|*Navn:* 
...
image::http://skjema.geonorge.no/SOSI/produktspesifikasjon/FKB-Veg/5.0/figurer/objtype_overkjorbartarealavgrensning.png[alt="Illustrasjon av objekttype: OverkjørbartArealAvgrensning"]
===== Egenskaper
[cols="20,80"]
|===
|*Navn:* 
...
image::http://skjema.geonorge.no/SOSI/produktspesifikasjon/FKB-Veg/5.0/figurer/objtype_skiltportal.png[alt="Illustrasjon av objekttype: Skiltportal"]
===== Egenskaper
[cols="20,80"]
|===
|*Navn:* 
...
image::http://skjema.geonorge.no/SOSI/produktspesifikasjon/FKB-Veg/5.0/figurer/objtype_trafikksignalpunkt.png[alt="Illustrasjon av objekttype: Trafikksignalpunkt"]
===== Egenskaper
[cols="20,80"]
|===
|*Navn:* 
...
image::http://skjema.geonorge.no/SOSI/produktspesifikasjon/FKB-Veg/5.0/figurer/objtype_vegbom.png[alt="Illustrasjon av objekttype: Vegbom"]
===== Egenskaper
[cols="20,80"]
|===
|*Navn:* 
...
image::http://skjema.geonorge.no/SOSI/produktspesifikasjon/FKB-Veg/5.0/figurer/objtype_vegoppmerking.png[alt="Illustrasjon av objekttype: Vegoppmerking"]
===== Egenskaper
[cols="20,80"]
|===
|*Navn:* 
...
image::http://skjema.geonorge.no/SOSI/produktspesifikasjon/FKB-Veg/5.0/figurer/objtype_vegrekkverk.png[alt="Illustrasjon av objekttype: Vegrekkverk"]
===== Egenskaper
[cols="20,80"]
|===
|*Navn:* 
...
image::http://skjema.geonorge.no/SOSI/produktspesifikasjon/FKB-Veg/5.0/figurer/objtype_vegskulderkant.png[alt="Illustrasjon av objekttype: Vegskulderkant"]
===== Egenskaper
[cols="20,80"]
|===
|*Navn:* 
...
image::diagrammer/Hoveddiagram datatyper og kodelister.png[link=diagrammer/Hoveddiagram datatyper og kodelister.png, window=_blank, alt="Diagramm: Hoveddiagram datatyper og kodelister"]
 
.Realisering av datatyper fra Vegnett 5.0 
image::diagrammer/Realisering av datatyper fra Vegnett 5.0.png[link=diagrammer/Realisering av datatyper fra Vegnett 5.0.png, window=_blank, alt="Diagramm: Realisering av datatyper fra Vegnett 5.0"]
