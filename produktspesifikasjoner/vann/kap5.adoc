...
==== Klasse «FeatureType» KystkonturTekniskeAnlegg
...
==== Klasse «FeatureType» VeggrøftÅpen
...
==== Klasse «FeatureType» SnøIsbreKant
...
==== Klasse «FeatureType» Flomløpkant
...
==== Klasse «FeatureType» VannFiktivGrense
...
==== Klasse «FeatureType» KonnekteringVann
...
==== Klasse «CodeList» Kystkonstruksjonstype
...
==== Klasse «CodeList» VannSperretype
