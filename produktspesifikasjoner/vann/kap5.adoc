...
*Definisjon:* konturlinje mellom land og innsjø    Merknad:  for innsjø som er oppdemt/regulert skal konturlinjen ligge i høydenivået for høyeste regulerte vannstand
