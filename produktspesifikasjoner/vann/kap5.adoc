...
image::http://skjema.geonorge.no/SOSI/produktspesifikasjon/FKB-Vann/5.0/figurer/objtype_skjær.png[alt="Illustrasjon av objekttype: Skjær"]
===== Egenskaper
[cols="20,80"]
|===
|*Navn:* 
...
image::http://skjema.geonorge.no/SOSI/produktspesifikasjon/FKB-Vann/5.0/figurer/objtype_innsjøkant.png[alt="Illustrasjon av objekttype: Innsjøkant"]
===== Egenskaper
[cols="20,80"]
|===
|*Navn:* 
...
image::http://skjema.geonorge.no/SOSI/produktspesifikasjon/FKB-Vann/5.0/figurer/objtype_innsjø.png[alt="Illustrasjon av objekttype: Innsjø"]
===== Egenskaper
[cols="20,80"]
|===
|*Navn:* 
...
image::http://skjema.geonorge.no/SOSI/produktspesifikasjon/FKB-Vann/5.0/figurer/objtype_kanalgrøft.png[alt="Illustrasjon av objekttype: KanalGrøft"]
===== Egenskaper
[cols="20,80"]
|===
|*Navn:* 
...
image::http://skjema.geonorge.no/SOSI/produktspesifikasjon/FKB-Vann/5.0/figurer/objtype_veggrøftåpen.png[alt="Illustrasjon av objekttype: VeggrøftÅpen"]
===== Egenskaper
[cols="20,80"]
|===
|*Navn:* 
...
image::http://skjema.geonorge.no/SOSI/produktspesifikasjon/FKB-Vann/5.0/figurer/objtype_snøisbrekant.png[alt="Illustrasjon av objekttype: SnøIsbreKant"]
===== Egenskaper
[cols="20,80"]
|===
|*Navn:* 
...
image::http://skjema.geonorge.no/SOSI/produktspesifikasjon/FKB-Vann/5.0/figurer/objtype_snøisbre.png[alt="Illustrasjon av objekttype: SnøIsbre"]
===== Egenskaper
[cols="20,80"]
|===
|*Navn:* 
...
image::http://skjema.geonorge.no/SOSI/produktspesifikasjon/FKB-Vann/5.0/figurer/objtype_flomløpkant.png[alt="Illustrasjon av objekttype: Flomløpkant"]
===== Egenskaper
[cols="20,80"]
|===
|*Navn:* 
