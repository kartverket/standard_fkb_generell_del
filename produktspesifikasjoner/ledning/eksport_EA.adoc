...
[[kopling_kurve]]
==== «FeatureType» Kopling_kurve (abstrakt)
...
[[kopling_punkt]]
==== «FeatureType» Kopling_punkt (abstrakt)
*Definisjon:* generell betegnelse på objekt som er node (punkt) i et ledningsnettverk
...
|Subtyper:
|<<kopling_punkt,«FeatureType» Kopling_punkt>> +
<<ledning,«FeatureType» Ledning>> +
<<kopling_kurve,«FeatureType» Kopling_kurve>> +
|Realisering av: 
...
[caption="Figur 18: ",title=Illustrasjon av objekttype Flymarkør]
...
[caption="Figur 19: ",title=Illustrasjon av objekttype Kanal]
...
[caption="Figur 20: ",title=Illustrasjon av objekttype Kumlokk]
...
[caption="Figur 21: ",title=Illustrasjon av objekttype Lysarmatur]
...
[caption="Figur 22: ",title=Illustrasjon av objekttype Mast]
...
|Beskrivelse: 
|linjebredde skal angis n&#229;r avstanden mellom ytterfasene (ledningene) er mer enn 10 meter i grunnriss
...
|Beskrivelse: 
|angis n&#229;r masten h&#248;yde over terreng, vann eller sj&#248; er &gt;15 meter
...
[caption="Figur 23: ",title=Illustrasjon av objekttype Nettverkstasjon]
...
|===
|*Navn:* 
|*skal ha tilhørende Nettverkstasjon med samme Driftsmerking*
 
|Beskrivelse: 
|EL_Nettstasjon og Nettverkstasjonomriss kobles sammen vha egenskapen Driftsmerking. Det vil si at alle geometriske objekter som beskriver ei fysisk mast, skal ha samme driftsmerking (koplingsnøkkel)
...
[caption="Figur 24: ",title=Illustrasjon av objekttype Skap]
...
[caption="Figur 25: ",title=Illustrasjon av objekttype Trase]
...
|Beskrivelse: 
|Hvert punkt i trasen skal ha lik koordinat som objekttype Mast.
...
|===
[caption="Figur 26: ",title=Illustrasjon av objekttype Vindturbin]
...
|===
|*Navn:* 
|*skal ha tilhørende Vindturbin med samme Driftsmerking*
 
|Beskrivelse: 
|Vindturbin og Vindturbinomriss kobles sammen vha egenskapen Driftsmerking. Det vil si at alle geometriske objekter som beskriver en fysisk vindturbin, skal ha samme driftsmerking (koplingsn&#248;kkel)
...
[caption="Figur 27: ",title=Illustrasjon av objekttype Åk]
