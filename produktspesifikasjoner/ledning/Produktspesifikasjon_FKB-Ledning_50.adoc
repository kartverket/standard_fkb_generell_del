...
* link:{prodspek-url}FKB-Ledning50.xsd[GML-Skjema]
* link:{prodspek-url}FKB-Ledning50.sch[Schematron-Skjema]
* link:{prodspek-url}eksempel/FKB-Ledning50.gml[GML-eksempelfil]
...
SOSI-realiseringen følger kravene i "Realisering i SOSI-foramt 5.0" <<SOSI>>. SOSI-filer som inneholder data i henhold til denne spesifikasjonen skal merkes i filhodet med ..OBJEKTKATALOG {fkbdatasett}. 
