include::../../felles/parametre.adoc[]
= SOSI-standardisert produktspesifikasjon: FKB-Ledning – 5.0
Geovekst
5.0, 2022-01-01
:fkbdatasett: FKB-Ledning 5.0
:publisert: Godkjent XX. XXXXXX 202X
:title-page-background-image: image:../../felles/figurer/forsidebilde_kartverketstandarder.jpg[]
:skjema-url: https://skjema.geonorge.no/SOSI/produktspesifikasjon/FKB-Ledning/5.0
:prodspek-url: https://sosi.geonorge.no/produktspesifikasjoner/FKB-Ledning
:reginstr-url: https://sosi.geonorge.no/registreringsinstrukser/FKB-Ledning/5.0
:reginstr-url-punktsky: https://sosi.geonorge.no/registreringsinstrukser/FKB-LedningPunktsky/5.0
:uml-url: http://sosi.geonorge.no/uml-modeller/sosi-del-3-produktspesifikasjoner/FKB-Ledning/5.0
:prodspek-forrige-url: https://register.geonorge.no/data/documents/Produktspesifikasjoner_FKB%20Ledning_v2_produktspesifikasjon-fkb-ledning-4_6_.pdf
...
include::nedlasting_pdf.adoc[]

*Publisert*: {publisert} +
*Denne versjonen finnes på*: {prodspek-url}/{revnumber} +
- {prodspek-url}/5.0[HTML-dokument] +
- {prodspek-url}/5.0/Produktspesifikasjon_FKB-Ledning_50.pdf[PDF-dokument] +
- {uml-url}[HTML-visning av UML-modellen] +
*Nyeste versjon finnes på*: {prodspek-url} +
*Denne versjonen erstatter*: {prodspek-forrige-url}[FKB-Ledning versjon 4.6] +
...
Fotogrammetrisk datafangst er den dominerende datafangstmetoden for {fkbdatasett}. Se {reginstr-url}[fotogrammetrisk registreringsinstruks for {fkbdatasett}]. {reginstr-url-punktsky}[Registreringsinstruks Punktsky FKB-Ledning] er også relevant for innsamling av utvalgte objekttyper.
...
* link:{prodspek-url}/FKBLedning50.sch[Schematron-regler til validering av tilleggskrav til datainnhold og -struktur utover det som defineres i GML-skjemafila]
