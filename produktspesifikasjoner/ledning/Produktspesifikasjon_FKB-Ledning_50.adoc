...
** _eksternPeker_, _nrlpeker_ og _nvdbpeker_ er lagt til som en opsjonelle egenskap (mulighet for å legge inn peker - i form av en URI - til objektet i andre systemer).
