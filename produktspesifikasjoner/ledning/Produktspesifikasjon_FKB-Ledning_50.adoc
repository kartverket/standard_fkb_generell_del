...
= SOSI-standardisert produktspesfikasjon: {fkbdatasett}
Geovekst
{versjon}, 2022-01-01
...
* link:{skjema-url}/FKBLedning50.xsd[GML-Skjema]
* link:{skjema-url}/FKBLedning50.sch[Schematron-regler til validering av tilleggskrav til datainnhold og -struktur utover det som defineres i GML-skjemafila]
