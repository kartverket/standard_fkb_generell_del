...
image::http://skjema.geonorge.no/SOSI/produktspesifikasjon/FKB-Ledning/5.0/figurer/Kanal.jpg[link=http://skjema.geonorge.no/SOSI/produktspesifikasjon/FKB-Ledning/5.0/figurer/Kanal.jpg, Alt="Bilde av et eksempel på objekttypen Kabelkanal, eventuelt med påtegning av streker som viser hvor geometrien til objektet skal måles fra."]
===== Arv og realiseringer
[cols="20,80"]
|===
|Supertype: 
