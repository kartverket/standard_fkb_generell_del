...
image::diagrammer/Luftlinje - alle egenskaper og realisering.png[link=diagrammer/Luftlinje - alle egenskaper og realisering.png, Alt="Diagram med navn Luftlinje - alle egenskaper og realisering som viser UML-klasser beskrevet i teksten nedenfor."]
...
image::http://skjema.geonorge.no/SOSITEST/produktspesifikasjon/FKB-Ledning/5.0/figurer/Aak.jpg[link=http://skjema.geonorge.no/SOSITEST/produktspesifikasjon/FKB-Ledning/5.0/figurer/Aak.jpg, Alt="Bilde av et eksempel på objekttypen Åk, eventuelt med påtegning av streker som viser hvor geometrien til objektet skal måles fra."]
===== Arv og realiseringer
[cols="20,80"]
|===
|Supertype: 
