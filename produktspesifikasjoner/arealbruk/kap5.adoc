...
.Oversiktsdiagram 
image::diagrammer/Oversiktsdiagram.png[link=diagrammer/Oversiktsdiagram.png, window=_blank, alt="Diagramm: Oversiktsdiagram"]
...
image::diagrammer/Hoveddiagram Driftsområder.png[link=diagrammer/Hoveddiagram Driftsområder.png, window=_blank, alt="Diagramm: Hoveddiagram Driftsområder"]
 
.Realisering fra Areal 4.0 Driftsområder 
image::diagrammer/Realisering fra Areal 4.0 Driftsområder.png[link=diagrammer/Realisering fra Areal 4.0 Driftsområder.png, window=_blank, alt="Diagramm: Realisering fra Areal 4.0 Driftsområder"]
...
image::http://skjema.geonorge.no/SOSI/produktspesifikasjon/FKB-Arealbruk/5.0/figurer/objtype_anleggsomrade.png[alt="Illustrasjon av objekttype: Anleggsområde"]
===== Egenskaper
[cols="20,80"]
|===
|*Navn:* 
...
image::http://skjema.geonorge.no/SOSI/produktspesifikasjon/FKB-Arealbruk/5.0/figurer/objtype_grustak.png[alt="Illustrasjon av objekttype: Grustak"]
===== Egenskaper
[cols="20,80"]
|===
|*Navn:* 
...
image::http://skjema.geonorge.no/SOSI/produktspesifikasjon/FKB-Arealbruk/5.0/figurer/objtype_industriomrade.png[alt="Illustrasjon av objekttype: Industriområde"]
===== Egenskaper
[cols="20,80"]
|===
|*Navn:* 
...
image::http://skjema.geonorge.no/SOSI/produktspesifikasjon/FKB-Arealbruk/5.0/figurer/objtype_steintipp.png[alt="Illustrasjon av objekttype: Steintipp"]
===== Egenskaper
[cols="20,80"]
|===
|*Navn:* 
...
image::diagrammer/Hoveddiagram Fritidsområder.png[link=diagrammer/Hoveddiagram Fritidsområder.png, window=_blank, alt="Diagramm: Hoveddiagram Fritidsområder"]
 
.Realisering fra Areal 4.0 Fritidsområder 
image::diagrammer/Realisering fra Areal 4.0 Fritidsområder.png[link=diagrammer/Realisering fra Areal 4.0 Fritidsområder.png, window=_blank, alt="Diagramm: Realisering fra Areal 4.0 Fritidsområder"]
...
image::http://skjema.geonorge.no/SOSI/produktspesifikasjon/FKB-Arealbruk/5.0/figurer/objtype_alpinbakke.png[alt="Illustrasjon av objekttype: Alpinbakke"]
===== Egenskaper
[cols="20,80"]
|===
|*Navn:* 
...
image::http://skjema.geonorge.no/SOSI/produktspesifikasjon/FKB-Arealbruk/5.0/figurer/objtype_campingplass.png[alt="Illustrasjon av objekttype: Campingplass"]
===== Egenskaper
[cols="20,80"]
|===
|*Navn:* 
...
image::http://skjema.geonorge.no/SOSI/produktspesifikasjon/FKB-Arealbruk/5.0/figurer/objtype_golfbane.png[alt="Illustrasjon av objekttype: Golfbane"]
===== Egenskaper
[cols="20,80"]
|===
|*Navn:* 
...
image::http://skjema.geonorge.no/SOSI/produktspesifikasjon/FKB-Arealbruk/5.0/figurer/objtype_lekeplass.png[alt="Illustrasjon av objekttype: Lekeplass"]
===== Egenskaper
[cols="20,80"]
|===
|*Navn:* 
...
image::http://skjema.geonorge.no/SOSI/produktspesifikasjon/FKB-Arealbruk/5.0/figurer/objtype_skytebane.png[alt="Illustrasjon av objekttype: Skytebane"]
===== Egenskaper
[cols="20,80"]
|===
|*Navn:* 
...
image::http://skjema.geonorge.no/SOSI/produktspesifikasjon/FKB-Arealbruk/5.0/figurer/objtype_sportidrettsplass.png[alt="Illustrasjon av objekttype: SportIdrettPlass"]
===== Egenskaper
[cols="20,80"]
|===
|*Navn:* 
...
image::diagrammer/Hoveddiagram Kulturområder.png[link=diagrammer/Hoveddiagram Kulturområder.png, window=_blank, alt="Diagramm: Hoveddiagram Kulturområder"]
 
.Realisering fra Areal 4.0 Kulturområder 
image::diagrammer/Realisering fra Areal 4.0 Kulturområder.png[link=diagrammer/Realisering fra Areal 4.0 Kulturområder.png, window=_blank, alt="Diagramm: Realisering fra Areal 4.0 Kulturområder"]
...
image::http://skjema.geonorge.no/SOSI/produktspesifikasjon/FKB-Arealbruk/5.0/figurer/objtype_gravplass.png[alt="Illustrasjon av objekttype: Gravplass"]
===== Egenskaper
[cols="20,80"]
|===
|*Navn:* 
...
image::http://skjema.geonorge.no/SOSI/produktspesifikasjon/FKB-Arealbruk/5.0/figurer/objtype_park.png[alt="Illustrasjon av objekttype: Park"]
===== Egenskaper
[cols="20,80"]
|===
|*Navn:* 
