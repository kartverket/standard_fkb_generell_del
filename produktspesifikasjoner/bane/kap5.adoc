...
==== Klasse «FeatureType» Jernbaneplattformkant
...
|===
Koder fra ekstern kodeliste kan hentes fra register: https://register.geonorge.no/sosi-kodelister/fkb/bane/5.0/jernbaneeier
 
==== Klasse «CodeList» Jernbanetype
