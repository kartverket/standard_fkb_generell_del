...
image::diagrammer/Hoveddiagram FKB-Bane 5.0.png[link=diagrammer/Hoveddiagram FKB-Bane 5.0.png, window=_blank, alt="Diagramm: Hoveddiagram FKB-Bane 5.0"]
...
image::http://skjema.geonorge.no/SOSI/produktspesifikasjon/FKB-Bane/5.0/figurer/objtype_jernbaneplattformkant.png[alt="Illustrasjon av objekttype: Jernbaneplattformkant"]
===== Egenskaper
[cols="20,80"]
|===
|*Navn:* 
...
image::http://skjema.geonorge.no/SOSI/produktspesifikasjon/FKB-Bane/5.0/figurer/objtype_spormidt.png[alt="Illustrasjon av objekttype: Spormidt"]
===== Egenskaper
[cols="20,80"]
|===
|*Navn:* 
