...
image::diagrammer/Hoveddiagram FKB-Lufthavn-5.0.png[link=diagrammer/Hoveddiagram FKB-Lufthavn-5.0.png, window=_blank, alt="Diagramm: Hoveddiagram FKB-Lufthavn-5.0"]
 
.Realisering 
image::diagrammer/Realisering.png[link=diagrammer/Realisering.png, window=_blank, alt="Diagramm: Realisering"]
...
image::https://skjema.geonorge.no/SOSI/produktspesifikasjon/FKB-Lufthavn/5.0/figurer/objtype_lufthavnlys.png[alt="Illustrasjon av objekttype: Lufthavnlys"]
===== Egenskaper
[cols="20,80"]
|===
|*Navn:* 
...
image::https://skjema.geonorge.no/SOSI/produktspesifikasjon/FKB-Lufthavn/5.0/figurer/objtype_rullebane.png[alt="Illustrasjon av objekttype: Rullebane"]
===== Egenskaper
[cols="20,80"]
|===
|*Navn:* 
...
image::https://skjema.geonorge.no/SOSI/produktspesifikasjon/FKB-Lufthavn/5.0/figurer/taksebanegrense.png[alt="Illustrasjon av objekttype: Taksebanegrense"]
===== Egenskaper
[cols="20,80"]
|===
|*Navn:* 
