...
= Produktspesfikasjon: {fkbdatasett}
Geovekst
{versjon}, 2022-01-01
...
****
[TIP]
Dette dokumentet kan også lastes ned link:{prodspek-url}/{versjon}/{datasett}.pdf[som PDF].
...
- {prodspek-url}/{versjon}/{datasett}.pdf[PDF-dokument] +
*Nyeste versjon finnes på*: {prodspek-url} +
*Denne versjonen erstatter*: {prodspek-forrige-url}[{versjon-forrige}] +
*Faglig godkjent av*: Geovekst +
*Formelt godkjent av*: Kartverket 
