...
Primært skal spesifikasjonen gi et rammeverk for bestilling av punktskydatasett, mend dokumentet skal også være en referanse for datasett som forvaltes i høydedata.no. 
