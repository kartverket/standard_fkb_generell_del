...
:prodspek-forrige-url: {reginstrbase-url}{datasett}/{versjon_forrige}
...
==== Endringer fra Punktsky 1.0 - 2022-01-01 til Punktsky 1.0.1 - 2022-01-01
Kun feilrettinger som ikke medfører behov for ny godkjenning er utført.
...
==== Endringer fra FKB-Laser 3.0 - 2021-01-01 til Punktsky 1.0 - 2022-01-01
