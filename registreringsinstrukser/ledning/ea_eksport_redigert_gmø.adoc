...
===== Ledningsnettverkstype: Kontaktledning
*Definisjon*: anlegg for strømforsyning gjennom takmontert strømavtakerutstyr på elektriske kjøretøy

.Senter topp mast registreres  
image::figurer/mast_kontaktledning.png[link=figurer/mast_kontaktledning.png, window=_blank, alt="Senter topp mast registreres"]

===== Ledningsnettverkstype: Signalanlegg
*Definisjon*: nettverk som brukes for å oversende og formidle trafikksignal

.Senter topp mast registreres  
image::figurer/mast_signalanlegg.png[link=figurer/mast_signalanlegg.png, window=_blank, alt="Senter topp mast registreres"]
