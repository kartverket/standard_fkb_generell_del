...
For kontaktledningsmaster angis egenskapen _konstruksjon_ med veriden "enkelStolpe"
                                                                                       
...
For signalmaster angis egenskapen _konstruksjon_ med veriden "enkelStolpe"
                                                                              
...
===== Tilleggsinformasjon for fotogrammetrisk registrering
Brukes ved registrering av traseer mellom master. En trase beskriver den geografisk plassering for en eller flere ledninger, (ledning = kabel, linje, r&#248;r osv.).
