...
*I FKB er det kun h&#248;gspenttraseer og andre traseer, ikke lavspent og ekom, som har luftspenn lengre enn 100 meter som er p&#229;krevd &#229; fotogrammetrisk registrere. Om andre traseer slik som belysning, ekom og lavspent skal registreres er opsjonelt.*
...
image:figurer/kumlokk_hydrant.png[link=figurer/kumlokk_hydrant.png,width=100,height=100, Alt="Senter topp hydrant skal registreres"]
|kvadratisk
|Kvadratisk
...
image:figurer/kumlokk_kvadratisk.png[link=figurer/kumlokk_kvadratisk.png,width=100,height=100, Alt="Senter kumlokk skal registreres. I bildet til venstre vises både et kvadratisk og sirkelformet kumlokk"]
|rektangulært
|Rektangulært
|kumlokket har utstrekning i form av et rektangel
 +
Senter kumlokk skal registreres
image:figurer/kumlokk_rektangulært.png[link=figurer/kumlokk_rektangulært.png,width=100,height=100, Alt="Senter kumlokk skal registreres"]
|sirkelforma
|Sirkelformet
|kumlokket er sirkelformet, rundt
 +
Senter kumlokk skal registreres
image:figurer/kumlokk_sirkulært.png[link=figurer/kumlokk_sirkulært.png,width=100,height=100, Alt="Senter kumlokk skal registreres"]
|sluk
|Sluk
|kumlokk eller &#229;pning med rist der overflatevann kan renne ned i avl&#248;pssystemet, ofte i forbindelse med vegsystemer
 +
Senter kumlokk skal registreres
image:figurer/kumlokk_sluk.png[link=figurer/kumlokk_sluk.png,width=100,height=100, Alt="Senter kumlokk skal registreres"]
|===
|===
|===
...
image:figurer/lysarmatur_hengendeIKabel.png[link=figurer/lysarmatur_hengendeIKabel.png,width=100,height=100, Alt="Topp senter lysarmatur for lysarmatur i vaier over gater/veger skal registreres"]
|iÅk
|I åk
...
image:figurer/lysarmatur_iÅk.png[link=figurer/lysarmatur_iÅk.png,width=100,height=100, Alt="Eksempel på registrering av lysarmatur i/på åk. Kun et utvalg armatur er markert med rød prikk. Dette er ikke en påkrevet registrering ved fotogrammetri."]
|iMast
|I mast
...
image:figurer/lysarmatur_iMast.png[link=figurer/lysarmatur_iMast.png,width=100,height=100, Alt="Eksempel på registrering av lysarmatur i mast. Kun et utvalg armatur er markert med rød prikk. Dette er ikke en påkrevet registrering ved fotogrammetri."]
|===
|===
|===
...
image:figurer/mast_annet.png[link=figurer/mast_annet.png,width=100,height=100, Alt="Telemaster, radiomaster etc. registreres som topp senter mast."]
|enkelStolpe
|EnkelStolpe
...
image:figurer/mast_enkelStolpe.png[link=figurer/mast_enkelStolpe.png,width=100,height=100, Alt="For enkeltstolper skal topp mast registreres. I noen tilfeller, typisk på veilys, må man generere topp mast (se figur lengst til høyre)"]
|fagverksmast
|Fagverksmast
|fagverk av metallkonstruksjoner
 +
Senter topp mast registreres
image:figurer/mast_fagverkmast.png[link=figurer/mast_fagverkmast.png,width=100,height=100, Alt="Senter topp mast registreres"]
|storStolpe
|StorStolpe
|stolpe(r) i h&#248;yspentlinjer som ikke er fagverksmast
 +
Senter topp mast registreres
image:figurer/mast_storStolpe.png[link=figurer/mast_storStolpe.png,width=100,height=100, Alt="Senter topp mast registreres"]
|===
|===
|===
...
|anlegg for str&#248;mforsyning gjennom takmontert str&#248;mavtakerutstyr p&#229; elektriske kj&#248;ret&#248;y
 +
Senter topp mast registreres
image:figurer/mast_kontaktledning.png[link=figurer/mast_kontaktledning.png,width=100,height=100, Alt="Senter topp mast registreres"]
|signalanlegg
|Signalanlegg
|nettverk som brukes for &#229; oversende og formidle trafikksignal
 +
Senter topp mast registreres
image:figurer/mast_signalanlegg.png[link=figurer/mast_signalanlegg.png,width=100,height=100, Alt="Senter topp mast registreres"]
|===
|===
|===
...
image:figurer/nettverkstasjon_frittstående.png[link=figurer/nettverkstasjon_frittstående.png,width=100,height=100, Alt="Eksempel på registrering av frittstående nettverkstasjon som representasjonspunkt. Uten manus vil det være vanskelig å skille frittstående nettverksstasjoner med andre bygninger, og man må derfor påregne at slike nettverkstasjoner blir registrert som Anne"]
|mastearrangement
|Mastearrangement
|nettverkstasjon hengende i mast
 +
Eksempel på registrering av mastearrangement som representasjonspunkt.
image:figurer/nettverkstasjon_mastearrangement.png[link=figurer/nettverkstasjon_mastearrangement.png,width=100,height=100, Alt="Eksempel på registrering av mastearrangement som representasjonspunkt."]
|mastefotkiosk
|Mastefotkiosk
|plassering av nettverkstasjon p&#229; bakkeniv&#229; mellom mastefundamentene

*H&#248;gspenttraseer er p&#229;krevd &#229; registrere ved fotogrammetrisk konstruksjon*
 +
Eksempel på registrering av mastefotkiosk som representasjonspunkt.
image:figurer/nettverkstasjon_mastefotstasjon.png[link=figurer/nettverkstasjon_mastefotstasjon.png,width=100,height=100, Alt="Eksempel på registrering av mastefotkiosk som representasjonspunkt."]
|minikiosk
|Minikiosk
|nettverkstasjon som minikiosk
 +
Eksempel på registrering av minikiosk som representasjonspunkt.
image:figurer/nettverkstasjon_minikiosk.png[link=figurer/nettverkstasjon_minikiosk.png,width=100,height=100, Alt="Eksempel på registrering av minikiosk som representasjonspunkt."]
|===
|===
|===
...
image:figurer/trase_belysningsanlegg.png[link=figurer/trase_belysningsanlegg.png,width=100,height=100, Alt="Eksempel på registrering av trase for belysningsanlegg. Til venstre er det gatelys og til høyre lysløype."]
|ekom
|Ekom
...
image:figurer/trase_ekom.png[link=figurer/trase_ekom.png,width=100,height=100, Alt="Eksempel på registrering av ekomlinje. I eksemplet benytter ekom-traseen de samme stolpene som en lavspenttrasen (fellesføring)."]
|høgspentnett
|Høgspentnett
|h&#248;gspentnett, &gt; 1 kV
 +
Eksempel på registrering av høgspentlinje
image:figurer/trase_høgspent.png[link=figurer/trase_høgspent.png,width=100,height=100, Alt="Eksempel på registrering av høgspentlinje"]
|lavspentnett
|Lavspentnett
|lavspentnett, &lt;= 1 kV
 +
Eksempel på registrering av lavspentlinje.
image:figurer/trase_lavspent.png[link=figurer/trase_lavspent.png,width=100,height=100, Alt="Eksempel på registrering av lavspentlinje."]
|===
