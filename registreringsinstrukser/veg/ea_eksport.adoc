...
image::figurer/gangsykkelveg_og_fortau_langs_veg.png[link=gangsykkelveg_og_fortau_langs_veg.png, Alt="Eksempel på registrering av Gang- og Sykkelveg og Fortau langs veg."]
