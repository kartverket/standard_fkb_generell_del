...
[caption="Figur  ",title= Figurene viser minstehøyde for AnnenBygning over 3m².
Bygningen til venstre skal registreres ettersom minstehøyde ved høyeste taknivå er over 2m (grønn pil).
Bygningen (hundehuset) til høyre skal ikke registreres ettersom minstehøyde ved høyeste taknivå er under 2m (rød pil).
]
...
[caption="Figur  ",title= Eksempel på registrering av takkant (takkant i rødt og taksprang i blått).
]
