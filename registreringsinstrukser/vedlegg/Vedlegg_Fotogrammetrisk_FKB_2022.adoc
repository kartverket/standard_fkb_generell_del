...
image::figurer/Veglenker1.png[alt="Bilde av veglenker"]
.Eksempel på riktig registrering av typeveg Gangfelt sammen med andre veglenker
image::figurer/Veglenker2.png[alt="Bilde av veglenker"]
.Eksempel på riktig registrering av typeveg Gangfelt sammen med andre veglenker
image::figurer/Veglenker3.png[alt="Bilde av veglenker"]
