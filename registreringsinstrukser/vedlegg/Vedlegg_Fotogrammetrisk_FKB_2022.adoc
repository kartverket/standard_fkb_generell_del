...
Dersom avstanden mellom ytterfasene er >10 meter i grunnriss skal _linjebredde_ konstrueres, men det er ikke krav om i tillegg å registrere _vertikalAvstand_ med mindre masten har en vertikal avstand > 15 meter. Tilsvarende gjelder dersom mastens _vertikalavstand_ er >15 meter. 
