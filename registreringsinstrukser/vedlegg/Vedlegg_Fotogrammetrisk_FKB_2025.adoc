...
I kap.3.3 Objekttype: VegGåendeOgSyklende og Tilleggsinformasjon for fotogrammetrisk registrering er det henvist til feil figur. Riktig tekst er _For typeveg-inndeling, se figur 15 i dette dokumentet_.
