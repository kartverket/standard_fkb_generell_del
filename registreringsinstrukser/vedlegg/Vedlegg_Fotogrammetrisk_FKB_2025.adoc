...
image::figurer_2024/baliser.png[alt="Bilde av baliser."]
...
image::figurer_2024/planovergang.png[alt="Bilde av planovergang langs jernbane."]
...
image::figurer_2024/vegbom.png[alt="Bilde av vegbom ved planovergang."]
