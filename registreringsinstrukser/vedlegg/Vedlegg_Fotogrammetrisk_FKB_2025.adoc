...
Det presiseres at TakoverbyggKant skal skrives med stor K. Dette er skrevet feil i rubrikkteksten for _kap.3.24 Objekttype TakoverbyggKant_.
...
I kap.3.5. Objekttype: Grunnmur og Tilleggsinformasjon for fotogrammetrisk registrering skal "opsjonell registrering" strykes fra teksten om Ruin. Riktig tekst er "Revede bygg/ruiner skal ikke registreres som grunnmur, men kan registreres som Ruin i FKB-BygnAnlegg".
...
==== Presisering for registrering av BeskrivendeHjelpelinjeAnlegg.
I kap.3.30. Objekttype: BeskrivendeHjelpelinjeAnlegg er det lagt til ny figur som skal illustrere at store solcelleanlegg på bakken skal registreres. Merk at mindre solcelleanlegg på tak ikke skal registreres.

.Illustrasjon av solcelleanlegg på bakken.
image::figurer_2025/solcelleanlegg.png[alt="Bilde av solcelleanlegg på bakken."]

==== Presisering for registrering av FlytebryggeUtligger.
...
image::figurer_2025/gjerde_port_bane.png[alt="Bilde av gjerde_port_bane."]

==== Reingjerde, ny godkjent gjerdetype.
...
==== Presisering for registrering av rørgater.
...
==== Presisering for registrering av Kum, Kumlokk og ledningsnettverkstype.
I kap.3.4. Objekttype: Kum og Tilleggsinformasjon for fotogrammetrisk registrering, presiseres det at Kumlokk som inngår i Kum skal registereres, selv om Kum er under minstemål og ikke registreres. Kum og Kumlokk skal alltid påføres LEDNINGSNETTVERKSTYPE ekom hvis den henger sammen med Kabelkanal.
...
.Illustrasjon av planovergang langs jernbane og vanlige objekttyper.
image::figurer_2025/planovergang.png[alt="Bilde av planovergang langs jernbane."]

.Illustrasjon av stasjonsområde langs jernbane og vanlige objekttyper.
...
==== Presisering for registrering av Innsjøkant.
I kap.3.9. Objekttype: Innsjøkant, presiseres det at ordet _oppdemt_ strykes i setningen _Merknad: for innsjø som er oppdemt/regulert skal konturlinjen ligge i høydenivået for høyeste regulerte vannstand_.
...
====  Presisering om registrering av vegbom.
