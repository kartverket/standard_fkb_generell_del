...
I kap.3.30. Objekttype: BeskrivendeHjelpelinjeAnlegg er det lagt til ny figur som skal illustrere at store solcelleanlegg på bakken skal registreres. Merk at solcelleanlegg på tak ikke skal registreres.
