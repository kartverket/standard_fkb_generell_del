...
I kapittel 3.1 Objekttype: Veglenke, Presiseringer til beskrivelsen av kodelistekoder, Typeveg - Kodenavn: Sti og Traktorveg, Tilleggsopplysninger FKB presiseres det at sti og traktorveg som krysser jernbane kun skal registreres der det er planovergang, bru (medium L) eller i tunnel/kulvert (medium U). Bane NOR leverer manus over planoverganger.
...
I kapittel 3.2. Objekttype: Trafikkøy, Tilleggsinformasjon for fotogrammetrisk registrering presiseres det at kun objekter som er øy i objekttypen VegKjørende skal registreres. Arealer som grenser til VegGåendeOgSyklende eller områder som ikke er flatedannet i FKB-Veg, skal ikke registreres som Trafikkøy. Det er lagt til to figurer som viser eksempler på arealer som ikke skal registreres som Trafikkøy.

.Eksempel på arealer som ikke skal registreres som Trafikkøy.
image::figurer_2026/ikke_trafikkoy2.png[alt="Bilde av arealer som ikke skal registreres som Trafikkøy."]
