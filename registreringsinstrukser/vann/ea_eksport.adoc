...
image::Objekttyper med egenskaper - Flateobjekter.png[Objekttyper med egenskaper - Flateobjekter]
[caption="Figur  ",title=Objekttyper med egenskaper - Flateavgrensninger]
image::Objekttyper med egenskaper - Flateavgrensninger.png[Objekttyper med egenskaper - Flateavgrensninger]
[caption="Figur  ",title=Objekttyper med egenskaper - Andre objekter]
image::Objekttyper med egenskaper - Andre objekter.png[Objekttyper med egenskaper - Andre objekter]
|===
|===
