...
* Mal for navn og innhold i diagrammer (utover kravene i SOSI)? 
...
Det anbefales at det defineres ett stk. bilde/bilde som generelt beskriver objektet som legges inn på denne taggen.  

.Eksempel på bruk av SOSI_bildeAvModellelement
image::figurer/bildeavmodellelement.png[]

*Avklares:* 
Bruke relativ sti eller absolutt sti til http://skjema.geonorge.no/SOSI/produktspesifikasjon/ et sted?
...
* Egenskapen Tilleggsinformasjon legges til på alle objekttyper. Ekstrainformasjon om registrering av objektet legges inn i notes-feltet for denne egenskapen.
